...
CREATE TABLE `benefit_points` (
  ...
  `points` decimal(10,2) NOT NULL DEFAULT 0 COMMENT '积分数量',
...
CREATE TABLE `point_transaction` (
  ...
  `change_point` decimal(10,2) NOT NULL COMMENT '变更积分',
  `points_after` decimal(10,2) NOT NULL COMMENT '变更后积分',
  `change_balance` decimal(10,2) NOT NULL COMMENT '变更余额',
