...
public class BenefitPoints {
    ...
    private BigDecimal points;  // 积分数量，默认值0
...
CREATE TABLE `benefit_points` (
  ...
  `points` decimal NOT NULL DEFAULT 0 COMMENT '积分数量',
...
(
    ...
    status                tinyint(1) default 1                 not null comment '状态: 0-失效; 1-活跃',
    create_time           datetime   default CURRENT_TIMESTAMP not null,
    update_time           datetime   default CURRENT_TIMESTAMP not null on update CURRENT_TIMESTAMP,
    constraint uk_user_active_status
        unique (user_id, status) comment '用户活跃购物车唯一约束'
)
    comment '购物车主表';
...
CREATE TABLE `point_transaction` (
  ...
  `change_point` decimal NOT NULL COMMENT '变更积分',
  `points_after` decimal NOT NULL COMMENT '变更后积分',
  `change_balance` decimal NOT NULL COMMENT '变更余额',
  `balance_after` decimal NOT NULL COMMENT '变更后余额',
...
(
    ...
    district       varchar(20)                        null comment '区县',
